...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className = 'inp inp__check';
    editInput.type = 'text';
    editInput.className = 'inp inp__text task';
...
var editTask=function(){
    ...
    var containsClass = listItem.classList.contains('list__item_mode');
    //If class of the parent is .list__item_mode
    if(containsClass){

        //switch to .list__item_mode
    ...
    //toggle .list__item_mode on the parent.
    listItem.classList.toggle('list__item_mode');
};
